"""Regression checks for the atlas-svc-cache-hub casebook."""
...
from casebook.harness import assert_expected, atlas_svc_cache_hub_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(atlas_svc_cache_hub_summary(), assert_expected())
