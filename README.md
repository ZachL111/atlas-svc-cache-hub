...
atlas-svc-cache-hub is a Kotlin project for backend services. It focuses on this technical goal: Design a Kotlin verification harness for cache systems, covering policy evaluation, deny and allow fixtures, and failure-oriented tests.
...
The core module exposes a small scoring API. Inputs are simple numeric signals: demand, capacity, latency, risk, and weight. The score uses a threshold of 158, risk penalty 7, latency penalty 2, and weight bonus 3. Tests exercise the public API against the fixture cases in `fixtures/cases.csv`.
