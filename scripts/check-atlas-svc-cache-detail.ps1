...
$repo = "atlas-svc-cache-hub"
$language = "Kotlin"
$category = "Backend services"

foreach ($path in @("metadata/domain-review.json", "config/review-profile.json", "fixtures/domain_review.csv", "docs/field-notes.md", "docs/review-journal.md", "examples/atlas-svc-cache-walkthrough.md")) {
